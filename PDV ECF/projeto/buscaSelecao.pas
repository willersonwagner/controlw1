      ...
      begin
        if DBGrid1.SelectedField.DisplayName = 'preco' then
          begin
            ...
            val := ArredondaPDV(DBGrid1.DataSource.DataSet.FieldByName('quant').AsCurrency * DBGrid1.DataSource.DataSet.FieldByName('precoOrigi').AsCurrency, 2);
            totalDesc := ArredondaPDV(DBGrid1.DataSource.DataSet.FieldByName('quant').AsCurrency * ent, 2);
