...
uses Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants,
  ...
  Vcl.StdCtrls, Vcl.Buttons, IBX.IBDatabase, Data.DB, IBX.IBCustomDataSet,
  IBX.IBQuery, Vcl.ExtCtrls, Vcl.AppEvnts, uClasses;
...
begin
  ...
  if Edit1.Text <> '' then IBDatabase1.DatabaseName := edit1.Text
    else edit1.Text := IBDatabase1.DatabaseName;
