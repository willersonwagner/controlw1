...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.ExtCtrls, Vcl.ExtDlgs, Data.DB, Vcl.Imaging.jpeg,
  Vcl.StdCtrls;
...
procedure TForm94.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TForm94.SetJPGCompression(ACompression: integer; const AInFile: string;const AOutFile: string);
var
...
function TForm94.PadronizaTamanho(Imagem: TGraphic; W, H: Integer;Tipo: TGraphicClass): TGraphic;
var
  B: TBitmap;
begin
  B := TBitmap.Create;
