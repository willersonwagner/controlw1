...
uses
  ...
  procedure LE_XMLNFE(const NuNF : String; var lista : TItensProduto; query : TFDQuery; var dadosNfe : TDadosNFe; chave1 : String = '');
...
//  function arredonda(valor : currency) : currency;
  ...
  procedure LE_XMLNFCE(const NuNF : String; var lista : TItensProduto; query : TFDQuery; var dadosNfe : TDadosNFe; porcPIS, porcCOFINS : currency);
  function VerificaCampoTabela1(NomeCampo, tabela : string; var query : TFDQuery) : boolean;
