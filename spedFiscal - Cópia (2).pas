...
uses
  ...
  unit1, ibquery, Contnrs, dbclient, dialog, classes1, func, untnfceForm;
...
type matrizCurrency = array of currency;
 ...
 type
  ...
  var
     ...
     CODCFOP, CODFOR, ERRO_CHAVE, arqTmp, valordg, _CNPJ, CST_PIS, chaveAnoMes : String;
     ...
     MAT_NOTA, MAT_NOTA1, codigosClientesExterior, lista0500 : TStringList;
            ...
            begin
              ...
              for ini := 0 to fim do
                begin
                  ...
                  if (trim(COD_ISPIS) = '') then CST_PIS := '';
