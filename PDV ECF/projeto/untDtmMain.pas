...
uses
  ...
  ACBrNFeDANFEClass, ACBrNFe, ACBrNFeDANFeESCPOS,
  ACBrDANFCeFortesFr, IBCustomDataSet, IBQuery, IBDatabase,
...
procedure TdtmMain.ACBrNFeStatusChange(Sender: TObject);
begin
